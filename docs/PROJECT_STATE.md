...
| — | Codex adversarial-review gates | `[x]` | **ADR-0010**, 2026-07-11: cross-provider two-gate workflow in CLAUDE.md (plan review before mutation; complete-diff review before completion); Codex read-only, user-scope MCP |
