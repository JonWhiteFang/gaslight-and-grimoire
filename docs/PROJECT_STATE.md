...
| — | Codex adversarial-review gates | `[x]` | **ADR-0013** (2026-07-14, supersedes **ADR-0010**): file-based cross-provider review (`codex/input`→`codex/output`) at three checkpoints — spec, plan, completed implementation; MCP `codex` tool retired for reviews. ADR-0010's original MCP two-gate model no longer operative. |
